...
function _coreLines(force = false) {
  ...
  return [
    ...
    `YOU ARE THE LEAD AGENT: for a big task with several INDEPENDENT parts, you can spawn SUBAGENTS — each a full agent with your tools that handles one part in parallel — then you synthesize their results into the final answer. You lead; they execute. Use it for genuinely parallel work (research several things at once, build multiple components, etc.), not for a single simple task.`,
