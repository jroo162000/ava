...
function CardBody({ c }) {
  ...
  if (t === 'web') return <div><iframe title={c.title} src={c.content} sandbox="allow-scripts allow-same-origin allow-popups" style={{ width: '100%', height: 300, border: 0, borderRadius: 8, background: '#fff' }} /><div style={{ fontSize: 11, color: '#64748b', marginTop: 4 }}>If blank, the site blocks embedding — <a href={c.content} target="_blank" rel="noreferrer" style={{ color: '#a78bfa' }}>open it</a>.</div></div>
  if (t === 'news') {
