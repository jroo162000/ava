...
class LLMService {
  ...
  async createCompletionOpenAI({ messages, system, temperature = 0.7, maxTokens = 1000, model, tools, signal }) {
  ...
  async createCompletionGemini({ messages, system, temperature = 0.7, maxTokens = 1000, model, tools, signal }) {
  ...
  async createCompletionGroq({ messages, system, temperature = 0.7, maxTokens = 1000, tools, signal }) {
